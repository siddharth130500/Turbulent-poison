...
# read data
data = torch.load("/home/siddharth/Turbulent_Flow/Turbulent-Flow-Net/rbc_data.pt")
...
for j in range(0, 1510-100):
    for i in range(7):
        torch.save(torch.FloatTensor(data_prep[i, j : j + 100]), "/data/siddharth/sample_" + str(j*7+i) + ".pt")
